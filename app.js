...
const App = () => {
    ...
    // ... (availableSeries, getFilteredResults, executeSearch, suggestions, clearHistory 邏輯保持不變) ...
    // 為節省篇幅，此處省略中間搜尋邏輯，請保留您原本 app.js 的這些函數 ...
        ...
        <div className="min-h-screen flex flex-col font-sans select-none relative bg-industrial-950 pb-20">
            ...
            <header className="dragon-header sticky top-0 z-40 px-4 py-3 flex items-center justify-between overflow-hidden">
                ...
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10 pointer-events-none">
                    ...
                    <span className="text-[9px] font-bold dragon-subtitle">PROFESSIONAL V13.9</span>
                </div>
                <div className="z-20">
                    <div className="text-[10px] bg-slate-800 px-2 py-1 rounded border border-slate-700 text-slate-400 font-mono">PRO</div>
                </div>
                    ...
                    <div className="animate-fade-in">
                        <div className="bg-industrial-800 p-4 rounded-xl border border-industrial-700 shadow-inner mb-6 space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <FilterSelect label="型式" value={searchState.type} options={['不拘', '壁掛式', '吊隱式', '室外機(一對多)', '室外機(商用)', '窗型']} onChange={v => setSearchState(p => ({...p, type: v}))} />
                            </div>
